...
Does the SDK provide a "pure Go native map executor" as a lightweight implementation of the `AgentRuntime` port (without relying on Python LangGraph / Java Spring AI instances)? Or just do remote binding?
